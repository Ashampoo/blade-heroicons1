...
use BladeUI\Heroicons1\BladeHeroicons1ServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('heroicon1-o-bell')->toHtml();
    ...
    {
        $result = svg('heroicon1-o-bell', 'w-6 h-6 text-gray-500')->toHtml();
    ...
    {
        $result = svg('heroicon1-o-bell', ['style' => 'color: #555'])->toHtml();
    ...
    protected function getPackageProviders($app)
    {
        return [
            ...
            BladeHeroicons1ServiceProvider::class,
        ];
    }
}
